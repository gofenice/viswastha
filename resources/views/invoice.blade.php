    ...
    <table>
        ...
        <tr>
            <td colspan="3"  rowspan="3"  style="text-align: center; vertical-align: middle;">
                ...
                <img src="{{ public_path('bgremlogo.png') }}" alt="VISHWASTHA" class="company-logo" style="max-width: 320px; display: block; margin: 0 auto 8px auto;"><br>
            ...
            <td colspan="3">
                <strong>Invoice No:</strong> V-0{{ $receipt_number }}
            </td>
            <td colspan="3">

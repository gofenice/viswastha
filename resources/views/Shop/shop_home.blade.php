                    ...
                    <div class="col-12 col-sm-6 col-md-3">
                        <div class="info-box">
                            ...
                            <div class="info-box-content">
                                <span class="info-box-text">Coupon Details</span>
                                <span class="info-box-number">Balance : {{ $shopCoupon->balance ?? 'No Coupon' }}</span>
                                <span class="info-box-number">Last Recharge :
                                    {{ \Carbon\Carbon::parse($shopCoupon->last_recharged_at ?? now())->format('d-m-Y') }}</span>
                            </div>
                        </div>
                    </div>

    ...
    <div class="content-wrapper">
        ...
        @if (Auth::check() && Auth::user()->role != 'superadmin')
            <div class="card card-info col-md-8" style="margin: 0 auto;">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form class="form-horizontal" method="POST" action="{{ route('update_wallet') }}"
        ...
        <div class="card mt-3 recieptList col-md-11 mx-auto">
            ...
            <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        @if (isset($reciepts['bankTransactionDetails']) && $reciepts['bankTransactionDetails']->isNotEmpty())
                            @foreach ($reciepts['bankTransactionDetails'] as $key => $reciept)
                                <tr>
                                    <td>{{ $key + 1 }}</td>
                                    ...
                                    <td>
                                        ...
                                        @elseif ($reciept->status === 'completed')

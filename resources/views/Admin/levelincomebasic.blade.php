    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Basic Level Incentive</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                            <li class="breadcrumb-item active">Basic Level Incentive List </li>
                        </ol>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table id="example1" class="table table-bordered table-striped text-center">
                        ...
                        <tbody>
                            @forelse ($levelincomes as $index => $levelincome)
                                <tr>
                                    ...
                                    @if (Auth::check() && Auth::user()->role === 'superadmin')
                                        <td>{{ $levelincome->sponsor->name }}<br>{{ $levelincome->sponsor->connection }}
                                        </td>
                                    @endif
                        ...
                        <tr>
                            <th colspan="6">Total Basic Level Income: {{ $totalAmount }}</th>
                        </tr>
                        </tfoot>
                    </table>
                </div>
...
@section('footer')
    <script>
        ...
        $(document).ready(function() {
            ...
            const matchLink = $('.nav-link.basiclevel');
            if (matchLink.length) {

...
@section('title', 'vishwastha   | Royalty Income')
@section('content')
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Royalty Income Details</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">Royalty Income</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    ...
    <div class="card card-info col-md-8" style="margin: 0 auto;">
        <div class="card-header">
            <h3 class="card-title">Royalty Income Details</h3>
        </div>
        <!-- /.card-header -->
        <!-- form start -->

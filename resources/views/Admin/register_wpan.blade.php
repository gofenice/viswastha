        ...
        <div class="card">
            <div class="card-body register-card-body">
                <p class="login-box-msg">Register a new membership</p>
                                          ...
                                          <form id="user-form" action="{{ route('register.store.wpan') }}" method="POST">
                                @csrf
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="sponsor_id" id="sponsor_id" class="form-control"
                                                value="{{ request()->get('sponsor_id') ?? ( $errors->has('sponsor_id') ? '' : old('sponsor_id')) }}" placeholder="Enter Sponsor ID" readonly required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="sponsor_name" id="sponsor_name" class="form-control"
                                               value="{{ request()->get('sponsor_name') ?? old('sponsor_name') }}" placeholder="Auto-filled" readonly>
                                            <span class="error-message text-danger"></span>
                                        </div>
                                    </div>

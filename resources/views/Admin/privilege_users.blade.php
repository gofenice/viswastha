    ...
    <div class="content-wrapper">
        ...
        <div class="card card-info col-md-4 mx-auto">
            <div class="card-header">
                <h3 class="card-title">Add Privilege Users</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <form method="POST" action="{{ route('add_privilege_user') }}" data-user-url="{{ route('get_user_name') }}"
                id="getUserId">
                @csrf
                <div class="card-body">
        ...
        <div class="card recieptList col-md-11 mx-auto">
            ...
            <div class="card-body">
                <table id="example1" class="table table-bordered table-striped text-center">
                    ...
                    <tbody>
                        @forelse($privilegeusers as $index => $user)
                            <tr>
                                <td>{{ $index + 1 }}</td>
    ...
    <div class="modal fade" id="editProductModal" tabindex="-1" aria-labelledby="editProductModalLabel"
            ...
            <div class="modal-dialog modal-md">
                <div class="modal-content">
                    <form id="editProductForm" method="POST" action="{{ route('edit_privilege_user') }}" enctype="multipart/form-data">
                        @csrf
...
@section('footer')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            const walletLink = $('.nav-link.privilegeuser');

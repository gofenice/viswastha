...
@section('title', 'vishwastha  | Bank Details')
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="card card-info col-md-8" style="margin: 0 auto;">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form class="form-horizontal" method="POST" action="{{ route('bank_details_update') }}"
                ...
                <div class="card-body">
                    <!-- <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" id="inputEmail3" value="{{ auth()->user()->name }}" disabled>
                                        </div>
                                    </div> -->
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="ifs_code"
                                ...
                                value="{{ old('ifs_code', $userBankDetails->ifs_code ?? '') }}"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="bank_name"
                                value="{{ old('bank_name', $userBankDetails->bank_name ?? '') }}" required>
                            @error('bank_name')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="branch_name"
                                value="{{ old('branch_name', $userBankDetails->branch_name ?? '') }}" required>
                            @error('branch_name')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="account_number"
                                value="{{ old('account_number', $userBankDetails->account_number ?? '') }}" required>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="account_holder_name"
                                value="{{ old('account_holder_name', $userBankDetails->account_holder_name ?? '') }}"
                                required>
                        ...
                        @if ($userBankDetails->status == 2)
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <img src="{{ asset($userBankDetails->bank_passbook_image) }}" width="300"
                                        height="200">
                                </div>
                                <div class="col-md-6">
                                    <label for="passbook">Pan card</label><br>
                                    <img src="{{ asset($userBankDetails->pancard_image) }}" width="300" height="200">
                                </div>
                            </div>
                        @else
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    @if ($userBankDetails->bank_passbook_image)
                                        <img src="{{ asset($userBankDetails->bank_passbook_image) }}" width="250"
                                            height="150">
                                    @endif
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    @if ($userBankDetails->pancard_image)
                                        <img src="{{ asset($userBankDetails->pancard_image) }}" width="250"
                                            height="150">
                                    @endif
                                </div>
                            </div>
                    ...
                    @if ($userBankDetails)
                        @if ($userBankDetails->status == 2)
                            {{-- Do nothing or add a success message --}}
                        @elseif ($userBankDetails->status == 0)
                            <span class="text-danger">{{ $userBankDetails->note }}</span>
                        ...
                        @endif
                    @else
                        {{-- If no user bank details exist, show the button --}}
                        <div class="card-footer">

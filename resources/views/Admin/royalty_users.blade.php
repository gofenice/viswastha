    ...
    <div class="content-wrapper">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Royalty</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        ...
        <div class="card card-info col-md-4 mx-auto">
            <div class="card-header">
                <h3 class="card-title">Add Royalty Users</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <form method="POST" action="{{ route('add_royalty_user') }}" data-user-url="{{ route('get_user_name') }}"
                id="getUserId">
                @csrf
                <div class="card-body">
        ...
        <div class="card recieptList col-md-11 mx-auto">
            ...
            <div class="card-body">
                <table id="example1" class="table table-bordered table-striped text-center">
                    ...
                    <tbody>
                        @forelse($royaltyusers as $index => $user)
                            <tr>
                                <td>{{ $index + 1 }}</td>
    ...
    <div class="modal fade" id="editProductModal" tabindex="-1" aria-labelledby="editProductModalLabel"
            ...
            <div class="modal-dialog modal-md">
                <div class="modal-content">
                    <form id="editProductForm" method="POST" action="{{ route('edit_royalty_user') }}" enctype="multipart/form-data">
                        @csrf
...
@section('footer')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            const walletLink = $('.nav-link.royaltyuser');

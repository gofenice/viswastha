...
@section('title', 'vishwastha | Rank Income')
@section('content')
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Premium Rank Incentive</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ route('adminhome') }}">Home</a></li>
                            <li class="breadcrumb-item active">Premium Rank Incentive</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <tbody>
                        @foreach ($ranks as $index => $rank)
                            <tr>
                                ...
                                @else
                                    <td>{{ $rank->rank ? $rank->rank->rank_name : 'N/A' }}</td>
                                @endif
...
@section('footer')
    <script>
        ...
        $(document).ready(function() {
            ...
            const directLink = $('.nav-link.rank');

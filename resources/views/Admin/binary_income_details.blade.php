...
@section('title', 'vishwastha   | Binary Income')
@section('content')
...
<div class="content-wrapper">
    ...
    <div class="card card-info col-md-8" style="margin: 0 auto;">
        <div class="card-header">
            <h3 class="card-title">Binary Income Details</h3>
        </div>
        <!-- /.card-header -->
        <!-- form start -->
        <form class="form-horizontal">
            <div class="card-body">
                <div class="form-group row">
                    <label for="inputEmail3" class="col-sm-4 col-form-label">Select Package Type</label>
                    <div class="col-sm-8">

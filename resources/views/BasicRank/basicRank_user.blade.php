...
<div class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>{{ $rank->name }} Users</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{route('adminhome')}}">Home</a></li>
                        {{-- <li class="breadcrumb-item"><a href="{{route('BasicRank_details')}}">Ranks</a></li> --}}
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Users in {{ $rank->name }} Rank</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                ...
                                <tbody>
                                    @if ($users->isNotEmpty())
                                        @foreach ($users as $key => $user)
                                            ...
                                            <tr>
                                                <td>{{ $key + 1 }}</td>
                                                <td><a data-toggle="modal" data-target="#listModal{{ $user->user_id }}">{{ $user->user->name }}</a></td>
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="listModal{{ $user->user_id }}">Sponsored Users of {{ $user->user->name }}</h5>
                                                        ...
                                                        <div class="modal-body">
                                                            @if ($users->isNotEmpty())
                                                                <ul>
                                                                    ...
                                                                    <li>{{ $sponsored_user->user->name }} (id {{ $sponsored_user->id }}) </li>
                                                                    @endforeach
                                                                </ul>
                                                            @else

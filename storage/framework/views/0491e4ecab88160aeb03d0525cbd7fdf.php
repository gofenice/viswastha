<?php $__env->startSection('title', 'VISHWASTHA | Binary Tree Migration'); ?>
...
.node-name { font-size: 36px; color: #222; font-weight: 600; margin-bottom: 12px; word-break: break-word; line-height: 1.35; }
...
.node-vol small { font-size: 24px; color: #555; font-weight: 600; line-height: 1.4; }
    ...
    <section class="content">
        <div class="container-fluid binary-page-wrapper">
            ...
            <div class="binary-topbar">
                <span class="migration-badge <?php echo e($settings->migration_complete ? 'complete' : 'pending'); ?>">
                    <i class="fas <?php echo e($settings->migration_complete ? 'fa-check-circle' : 'fa-clock'); ?>"></i>
                    <?php echo e($settings->migration_complete ? 'Migration Complete' : 'Migration In Progress'); ?>

                </span>

                
                <?php if(!$isGlobalRoot && $currentNode): ?>
                    <button onclick="history.back()" class="btn btn-secondary btn-sm">
                        <i class="fas fa-arrow-left"></i> Back
                    </button>
                <?php endif; ?>

                <?php if($currentNode && !$isGlobalRoot): ?>
                    <a href="<?php echo e(route('admin.binary_tree')); ?>" class="btn btn-outline-secondary btn-sm">
                        <i class="fas fa-home"></i> Global Root
                    </a>
                <?php endif; ?>

                <?php if(!$settings->migration_complete): ?>
                    <?php if(!$settings->root_user_id): ?>
                ...
                <?php if($currentNode): ?>
                    <span class="ml-auto text-muted small" style="font-size:12px;">
                        Viewing: <strong><?php echo e($currentNode->name); ?></strong> (<?php echo e($currentNode->connection); ?>)
                    </span>
                <?php endif; ?>
            </div>
...
const RAW_TREE = <?php echo json_encode($binaryTree, 15, 512) ?>;

// ── Tree layout constants ─────────────────────────────────────────────────────
const NW        = 408;  // node width
const NH        = 552;  // node height
...
// ── ROUTES ────────────────────────────────────────────────────────────────────
const ROUTES = {
    setRoot:            '<?php echo e(route("admin.binary_tree.set_root")); ?>',
    transferUser:       '<?php echo e(route("admin.binary_tree.transfer_user")); ?>',
    removeUser:         '<?php echo e(route("admin.binary_tree.remove_user")); ?>',
    searchUsers:        '<?php echo e(route("admin.binary_tree.search_users")); ?>',
    completeMig:        '<?php echo e(route("admin.binary_tree.complete_migration")); ?>',
    registerWithPan:    '<?php echo e(route("register.store")); ?>',
    registerWithoutPan: '<?php echo e(route("register.store.wpan")); ?>',
    reload:             '<?php echo e(route("admin.binary_tree")); ?>',
    checkSlots:         '<?php echo e(route("admin.binary_tree.check_slots")); ?>',
    moveUser:           '<?php echo e(route("admin.binary_tree.move_user")); ?>',
    userPackages:       '<?php echo e(route("admin.binary_tree.user_packages")); ?>',
};
...
<?php echo $__env->make('Admin.admin_header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/shiyasnazar/php/vishwastha/resources/views/Admin/binary_tree_admin.blade.php ENDPATH**/ ?>
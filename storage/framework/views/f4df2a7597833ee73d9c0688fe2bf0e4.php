<?php $__env->startSection('title', 'vishwastha | My Team'); ?>
<?php $__env->startSection('content'); ?>
    ...
    <div class="content-wrapper">
        ...
        <div class="container">
            <?php if($user->pan_card_no === $loggedUser->pan_card_no || (Auth::check() && Auth::user()->role === 'superadmin')): ?>
                <div class="row" style="justify-content: center">
                    <div class="col-lg-4 col-6">
                        <div class="small-box bg-info">
                            <div class="inner">
                                <h4><b><?php echo e($user->name); ?></b></h4>

                                <p><?php echo e($user->connection); ?></p>
                            </div>
                            <div class="icon">
                    ...
                    <div class="col-lg-4 col-6">
                        <div class="small-box bg-danger">
                            <div class="inner">
                                ...
                                <h3>₹<?php echo e($referrelbasic ?? 0); ?></h3>
                    ...
                    <div class="col-lg-4 col-6">
                        <div class="small-box bg-custom">
                            <div class="inner">
                                <h3>₹<?php echo e($referrelpremium); ?></h3>
                    ...
                    <div class="col-lg-4 col-6">
                        <div class="small-box bg-custom">
                            <div class="inner">
                                <h3>₹<?php echo e($levelpremium ?? 0); ?></h3>
                    ...
                    <div class="col-lg-4 col-6">
                        <div class="small-box bg-warning">
                            <div class="inner">
                                <h3>₹<?php echo e($basicRankincome); ?></h3>
                    ...
                    <div class="col-lg-4 col-6">
                        <div class="small-box bg-indigo">
                            <div class="inner">
                                <h3>₹<?php echo e($royaltyIncome); ?></h3>
                    ...
                    <div class="col-lg-4 col-6">
                        <div class="small-box bg-fuchsia">
                            <div class="inner">
                                <h3><?php echo e($PrivilegeIncome); ?></h3>
                    ...
                    <div class="col-lg-4 col-6">
                        <div class="small-box bg-maroon">
                            <div class="inner">
                                <h3>₹<?php echo e($ExecutiveIncome); ?></h3>
                    ...
                    <div class="col-lg-4 col-6">
                        <div class="small-box bg-success">
                            <div class="inner">
                                <h3>₹<?php echo e($repurchaseTotal); ?></h3>
                    ...
                    <div class="col-lg-4 col-6">
                        <div class="small-box bg-info">
                            <div class="inner">
                                <h3>₹<?php echo e($selfpurchaseTotal); ?></h3>
                    ...
                    <div class="col-lg-4 col-6">
                        <div class="small-box bg-primary">
                            <div class="inner">
                                <h3>₹<?php echo e($franchiseeTotal); ?></h3>
            ...
            <div class="row d-flex">
                <div class="col-md-4" style="margin: 0 auto;">
                    <form action="<?php echo e(route('sunflower')); ?>" method="GET" class="mb-4">
                        <?php echo csrf_field(); ?>
                        <div class="card-body">
            ...
            <?php if($sponsor && $user->id !== auth()->id()): ?>
                <div class="back-parent">
                    <a href="<?php echo e(route('sunflower', ['id' => $sponsor->id])); ?>"
        ...
        <div class="card mt-3">
            <div class="card-body">
                <h3><b><?php echo e($user->name); ?>'s</b> Team <button class="btn btn-primary no-user clickable"
                        data-parent-id="2" data-position-index="left"
                        <?php echo e(empty($user->userPackages->pluck('package_id')->toArray()) ? 'disabled' : ''); ?>><i
                            class="fas fa-plus"></i> New User</button>
                    <button class="btn btn-info"><a style="color: white;"
                            href="<?php echo e(route('user_registration_form')); ?>"><i class="fas fa-plus"></i> New User Without Pan
                            Card</a></button>
                </h3>
                <div class="mb-3">
                    <p class="mb-0"><b>Rank : </b> <span
                            class="badge rank-bg-<?php echo e(Str::slug($user->rank->rank_name, '-')); ?>">
                            <?php echo e($user->rank->rank_name); ?></span></p>
                    <b>Package :</b>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered nested-table text-center" id="example1">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $downlines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $downline): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td><?php echo e($index + 1); ?></td>
                                    <td>
                                        <a href="<?php echo e(route('sunflower', $downline->id)); ?>">
                                            <?php echo e($downline->name); ?> <br> <?php echo e($downline->connection); ?>

                                        </a>
                                    </td>
                                    <td> <span
                                            class="badge rank-bg-<?php echo e(Str::slug($downline->rank->rank_name, '-')); ?>"><?php echo e($downline->rank->rank_name); ?></span>
                                    </td>
                                    <td>
                                        <?php if($downline->userPackages->isNotEmpty()): ?>
                                            <?php echo e($downline->userPackages->pluck('package.name')->join(', ')); ?>
    ...
    <div class="modal fade" id="modal-lg">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <form id="user-form" action="<?php echo e(route('register.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="modal-body row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="sponsor_id" id="sponsor_id" class="form-control"
                                value="<?php echo e(old('sponsorId')); ?>" required>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="sponsor_name" id="sponsor_name" class="form-control"
                                value="<?php echo e(old('sponsor_name')); ?>" readonly>
                            <span class="error-message text-danger"></span>
                        </div>
                        <div class="form-group col-md-6">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="pan_card_no" id="pan_card_no" class="form-control"
                                oninput="this.value = this.value.toUpperCase()" value="<?php echo e(old('pan_card_no')); ?>"
                                required>
                            <span class="error-message text-danger"></span>
                        </div>
                        ...
                        <div class="form-group col-md-12">
                            <input name="psgdpr" type="checkbox" value="1" required checked>
                            <label>I agree to the <a href="<?php echo e(route('terms')); ?>">Terms and Conditions </a>and the Privacy
                                Policy</label>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="packageModal" tabindex="-1" aria-labelledby="packageModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form id="updatePinForm" method="POST" action="<?php echo e(route('update_pin')); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="modal-header">
...
<?php echo $__env->make('Admin.admin_header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/shiyasnazar/php/vishwastha/resources/views/Admin/sunflower_tree.blade.php ENDPATH**/ ?>